        ...
        <form>
          <ul>
            <li>
              ...
              <div className="desc">
                <p>
                  ㈜엣지크로스(이하 '회사')은 정보통신망 이용촉진 및 정보보호
                  등에 관한 법률, 개인정보보호법 등 관련법령에 의거한
            ...
            <li>
              ...
              <div className="desc">
                <p>
                  ...
                  ㈜엣지크로스(이하 “엣지크로스”)이 제공하는 제품, 소프트웨어,
                  인적 서비스, 기능 등(이하 “서비스”)을 엣지크로스의 서비스
                  웹사이트(이하 “서비스 웹사이트”) 상에서 이용하고자 본 약관에
                  동의하는 주체(“고객”) 간 의무와 권리 및 책임사항을 정하고
                  있습니다. 본 약관에 동의하는 경우 ‘동의합니다’ 에
                  체크하십시오.
                </p>
              </div>
            </li>
            <li>
              ...
              <div className="desc">
                <p>
                  ...
                  계약시 정한 주기 동안 유효하다. 다만 엣지크로스는 고객에게
                  계약기간 만료 전까지 계약기간 만료 일 계약종료 의사표시 계약의
