...
const apis = {
  ...
  plcInputData: (id: string | undefined, keyword: string | undefined) => api.get(`/equipment/${id}/input?search=${keyword}`),
  plcOutputData: (id: string | undefined, keyword: string | undefined)=> api.get(`/equipment/${id}/output?search=${keyword}`),
  getParameterData: (id: string | undefined, keyword: string | undefined) => api.get(`/equipment/${id}/parameter?search=${keyword}`),
  ...
  //A/S HISTORY
  getAsHistory: (id: string | undefined, currentPage: number | undefined) => api.get(`/equipment/${id}/repair?page=${currentPage}&size=10`),
  getAsDetail: (id: string | undefined, postId: string | undefined) => api.get(`/equipment/${id}/repair/${postId}`),
